        ...
        <v-card>
          ...
          <v-list>
            ...
            <v-list-item router to="/studio">
              ...
              <v-list-item-title>R.Hub Studio</v-list-item-title>
            </v-list-item>
        ...
        <v-list dense nav class="py-0" tag="div">
          ...
          >
            <v-app-bar-nav-icon
              ...
              class="mr-5"
            ></v-app-bar-nav-icon>
            <v-toolbar-title class="font-weight-bold">R.Hub</v-toolbar-title>
          </v-list-item>
